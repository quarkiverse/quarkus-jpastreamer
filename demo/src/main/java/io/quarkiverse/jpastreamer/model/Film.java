...
public class Film {
    ...
    public boolean equals(Object o) {
        ...
        if (filmId != film.filmId)
            return false;
        if (rentalDuration != film.rentalDuration)
            return false;
        ...
        if (description != null ? !description.equals(film.description) : film.description != null)
            return false;
        if (rentalRate != null ? !rentalRate.equals(film.rentalRate) : film.rentalRate != null)
            return false;
        if (length != null ? !length.equals(film.length) : film.length != null)
            return false;
